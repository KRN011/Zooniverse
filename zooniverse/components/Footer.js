...
const Footer = () => {
  return (
    <footer>
      <div className="h-1 w-full bg-green-700 mt-16"></div>

      {/* upper */}
      <div className="flex justify-between items-center">
        <div className="pl-52 -translate-y-12">
          <img
            src="images/logo.png"
            alt=""
        ...
        <div>
          <ul className="flex gap-8 -translate-y-12 pr-52 text-green-700 font-medium">
      ...
      <div className="h-1px w-3/4 bg-green-700 flex m-auto opacity-50 -translate-y-24"></div>

      {/* lower */}
      <div className="m-auto w-3/4 px-5 -translate-y-10 text-green-700 flex flex-col gap-8">
        {/* upper */}
        <div className="flex justify-between">
          <div className="text-xl w-2/5">
        ...
        {/* lower */}
        <div className="flex justify-between">
          <div className="font-thin">Copyright © All rights Reserved</div>
          {/* social media icons */}
          <div className="flex gap-3">
            {/* facebook */}
            <Link href='https://www.facebook.com/'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 fill-current text-green-700 duration-150 transform hover:scale-105">
            ...
            <Link href='https://www.instagram.com'><svg
              viewBox="0 0 16 16"
              className="w-7 fill-current text-green-700 duration-150 transform hover:scale-105"
            >
            ...
            <Link href='https://www.linkedin.com'><svg
              ...
              className="w-8 fill-current text-green-700 duration-150 transform hover:scale-105"
            >
