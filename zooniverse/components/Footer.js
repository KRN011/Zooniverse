      ...
      <div className="m-auto w-3/4 px-5 -translate-y-10 text-green-700 flex flex-col gap-8">
        ...
        <div className="flex justify-between">
          ...
          <div className="text-xl">
            <div>zooverse@ahmedabad.com</div>
            +91 8769577644
          </div>
        </div>
        {/* lower */}
        <div className="flex justify-between">
          ...
          <div className="flex gap-3">
            {/* facebook */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 fill-current text-green-700">
            ...
            <svg
              viewBox="0 0 16 16"
              className="w-7 fill-current text-green-700"
            >
            ...
            <svg
              ...
              className="w-8 fill-current text-green-700"
            >
